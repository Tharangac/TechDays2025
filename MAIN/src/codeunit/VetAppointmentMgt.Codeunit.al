...
codeunit 50100 "Vet Appointment Mgt._TD"
{
    trigger OnRun()
    begin
    end;
    ...
    var
        VetAppointment: Record "Vet Appointment_TD";
        ...
        JToken: JsonToken;
        RequestID: Text;
        VetAppointmentEvent: Codeunit "Vet Appointment Events_TD";
        newGuid: Guid;
    begin
        VetAppointment.Init();
        ...
        VetAppointmentEvent.NewVetAppointmentRequestRaised(VetAppointment."Appointment ID");
    ...
    procedure CheckAppointmentStatus(APIRequestID: Text): Enum "Vet Appointment Status_TD"
    var
        VetAppointment: Record "Vet Appointment_TD";
        Client: HttpClient;
        ResponseMessage: HttpResponseMessage;
